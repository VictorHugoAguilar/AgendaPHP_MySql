...
function leerFormulario(e) {
     ...
     if (nombre === '' || empresa === '' || telefono === '') {
          ...
          mostrarNotificacion('Compruebe los Campos Obligatorios', 'error');
     } else {
...
function eliminarContacto(e) {
     if (e.target.parentElement.classList.contains('btn-borrar')) {
          ...
          const respuesta = confirm('¿Estás Seguro de eliminar el conctacto ?');
          ...
          if (respuesta) {
               ...
               // abrir la conexión
               xhr.open('GET', `inc/model/model.contact.php?id=${id}&accion=borrar`, true);
